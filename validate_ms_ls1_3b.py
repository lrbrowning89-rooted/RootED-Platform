...
rows = conn.execute("""
    ...
    WHERE q.objective_id = 'MS-LS1-3B'
...
print("\nARCHIVED MS-LS1-3B QUESTIONS:")
archived = conn.execute("""
    SELECT question_id, original_objective_id, stem
    FROM archived_questions
    WHERE original_objective_id='MS-LS1-3B'
    ORDER BY archived_at DESC, question_id
""").fetchall()
print("ARCHIVED COUNT:", len(archived))
for r in archived[:5]:
    print(r["question_id"], "|", r["stem"])
